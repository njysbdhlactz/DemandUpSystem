		...
		<s:form action="DemandAction-saveE" method="post">
			...
			<table>
				...
				<tr name="a" id="a">
					...
					<%-- <s:select list="" id="demandClass1" onchange="changefirst_xk()"
					 name="demandClass1"></s:select>
					 <s:select list="" id="demandClass2" onchange="changesecond_xk()"
					 name="demandClass2"></s:select>
					 <s:select list="" id="demandClass3"
					 name="demandClass3"></s:select> --%>
					 <select name="demandClass1"
						id="demandClass1" onchange="changefirst_xk()">
						<option value="${demandClass1 }" selected="selected">
						${demandClass1 }</option>
					</select> <select name="demandClass2" id="demandClass2"
						onchange="changesecond_xk()">
						<option value="${demandClass2 }" selected="selected">
						${demandClass2 }</option>
					</select> <select name="demandClass3" id="demandClass3">
						<option value="${demandClass3 }" selected="selected">
						${demandClass3 }</option>
					</select>
					</td>
				</tr>
				...
				<tr name="c" id="c">
					...
					<td colspan="5">（参见国民经济行业分类）<select
						...
						<option value="${demandEconomicClass1 }" selected="selected">
						${demandEconomicClass1 }</option>
					</select> <select name="demandEconomicClass2" id="demandEconomicClass2"
						onchange="changesecond_xq()">
						<option value="${demandEconomicClass2 }" selected="selected">
						${demandEconomicClass2 }</option>
					</select> <select name="demandEconomicClass3" id="demandEconomicClass3">
						<option value="${demandEconomicClass3 }" selected="selected">
						${demandEconomicClass3 }</option>
