...
{//alert("4444");
	...
	document.getElementById('ksxkjs').checked=false;
	document.getElementById('ksjjjs').checked=false;
		$.ajax({
            		...
            		success : function(data)
					{
						...
						$.each(
							...
							function(i, item)
							{
								...
								if(item.permission=="快速学科检索")
									document.getElementById('ksxkjs').checked=true;
								if(item.permission=="快速经济检索")
									document.getElementById('ksjjjs').checked=true;
							}
						);
            		},
...
<table>
	...
	<tr>
		<td align="center">快速学科检索</td>
		<td align="center"><input type="checkbox" id="ksxkjs" name="ksxkjs" value="快速学科检索"></input></td>
	</tr>
	<tr>
		<td align="center">快速经济检索</td>
		<td align="center"><input type="checkbox" id="ksjjjs" name="ksjjjs" value="快速经济检索"></input></td>
	</tr>
	<tr>
