...
//		}
	...
	public String permitSet()
	{
    	...
    	String ksxkjs=requestV.getParameter("ksxkjs");
    	if(ksxkjs==null)
    	{
    		userPermisService.permitSetDel(typeName, "快速学科检索");
    	}
    	else
    	{
    		userPermisService.permitSetNewPermit(typeName, ksxkjs);
    	}
    	String ksjjjs=requestV.getParameter("ksjjjs");
    	if(ksjjjs==null)
    	{
    		userPermisService.permitSetDel(typeName, "快速经济检索");
    	}
    	else
    	{
    		userPermisService.permitSetNewPermit(typeName, ksjjjs);
    	}
