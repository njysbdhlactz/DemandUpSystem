...
public class DemandService
{
	...
	public List<Demand> getTreeList1(String name,String num)//2,5,7
	{
		String cla=null;
		if(num.equals("2"))
			cla="demandClass1";
			...
			cla="demandClass3";
		String hql = "FROM Demand d LEFT OUTER JOIN FETCH d.unit " +
				"LEFT OUTER JOIN FETCH d.unit.unitNumber " +
				"where d."+cla+" ='"+ name + "'";
		return demandDao.getByHql(hql);
	}
	public List<Demand> getTreeList2(String name,String num)//2,5,7
	{
		String cla=null;
		if(num.equals("1"))
			cla="demandEconomicClass1";
		else if(num.equals("3"))
			cla="demandEconomicClass2";
		else if(num.equals("5"))
			cla="demandEconomicClass3";
		String hql = "FROM Demand d LEFT OUTER JOIN FETCH d.unit " +
				"LEFT OUTER JOIN FETCH d.unit.unitNumber " +
				"where d."+cla+" ='"+ name + "'";
		return demandDao.getByHql(hql);
